...
function PlaylistTrackDOM(props: TrackProps) {
    ...
    const playTrackInPlaylist = (playlistUri: string | undefined, trackUri: string) => {
        console.log(`PlayTrackInPlaylist: ${playlistUri}-${trackUri}`);
        let requestConfig = {
...
export default PlaylistTrackDOM;